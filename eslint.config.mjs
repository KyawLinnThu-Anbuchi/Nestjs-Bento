  ...
  },
  {
    rules: {
      ...
      '@typescript-eslint/naming-convention': [
        'error',
        { selector: 'function', format: ['camelCase'] }, // e.g. `getUser`
        {
          selector: 'variable',
          format: ['camelCase', 'snake_case', 'UPPER_CASE', 'PascalCase'],
          leadingUnderscore: 'allow',
        }, // e.g. `userData`, `user_id`, `USER_ID`, `ResponseData`
        ...
        { selector: 'classProperty', format: ['camelCase', 'snake_case'] }, // e.g. `userId` or `user_id`
      ],
